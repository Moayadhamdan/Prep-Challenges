...
const objLat = (obj) => {
    ...
    const capitalizedFirstName = obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1).toLowerCase();
    const capitalizedLastName = obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1).toLowerCase();
...
const classesAvg = (data) => {
    ...
    data.grades.forEach(grade => {
        ...
        grade.classes.forEach(classroom => {

            const totalScores = classroom.classScores.reduce((acc, score) => acc + score, 0);
            const avgScore = Math.floor(totalScores / classroom.classScores.length);


            classroom.avg = avgScore;
        });
    });
